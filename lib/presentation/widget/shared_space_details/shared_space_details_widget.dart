          ...
          child: Column(
              ...
              children: [
                Padding(
                    padding: EdgeInsets.only(top: 8),
                    child: Text(
                      auditLogEntryUser.getResourceName(auditLogEntryUser),
                      maxLines: 1,
                      style: TextStyle(fontSize: 14, color: AppColor.documentNameItemTextColor),
                    )
                ),
                _buildActionDetailsText(auditLogEntryUser.getActionDetails(context)),
                Padding(
                    padding: EdgeInsets.only(top: 8),
                    child: Text(
                      auditLogEntryUser.getLogTimeAndByActor(context),
