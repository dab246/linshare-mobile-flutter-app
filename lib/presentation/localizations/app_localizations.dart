...
class AppLocalizations {
  ...
  String audit_action_message_copy_document_from_personal_space(String authorName, String resourceName, String nameVarious) {
    return Intl.message(
  ...
  String audit_action_message_copy_document_from_received_share(String authorName, String resourceName, String nameVarious) {
    return Intl.message(
        '$authorName has created the document : $resourceName into $nameVarious, from his received share.',
  ...
  String audit_action_message_copy_document_to_personal_space(String authorName, String resourceName) {
    return Intl.message(
